...
import { getFirestore, collection, query, where } from "firebase/firestore"; // ✅ NEW
...
export { storage, auth, provider, signInWithPopup, signOut, db, collection, query, where }; // ✅ UpdatedPDATED
